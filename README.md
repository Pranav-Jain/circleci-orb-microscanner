...
The MicroScanner Orb is an easy way to get started creating free, automated vulnerability assessment reports. These reports are posted to CircleCi's build artefact area.
...
Add the first two lines of the following example to the beginning of 
...
A report is created upon a failed scan. This is linked to within the CircleCi as an artefact. Navigate to the artefact tab in the CircleCi dashboard for viewing this report.
